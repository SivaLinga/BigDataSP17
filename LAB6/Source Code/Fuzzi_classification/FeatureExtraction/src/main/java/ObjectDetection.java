...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/bunny.mkv"));
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/11.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/12.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/13.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
